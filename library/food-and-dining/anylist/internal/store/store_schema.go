...
CREATE TABLE IF NOT EXISTS recipes (
    id TEXT PRIMARY KEY,
    name TEXT NOT NULL,
    paprika_identifier TEXT DEFAULT '',
    note TEXT DEFAULT '',
...
`
	...
	for _, column := range []struct {
		...
		{table: "items", name: "photo_ids", ddl: "TEXT DEFAULT '[]'"},
		{table: "items", name: "prices", ddl: "TEXT DEFAULT '[]'"},
		{table: "items", name: "category_assignments", ddl: "TEXT DEFAULT '[]'"},
		{table: "recipes", name: "paprika_identifier", ddl: "TEXT DEFAULT ''"},
	} {
